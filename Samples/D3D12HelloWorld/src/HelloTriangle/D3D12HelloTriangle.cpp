...
void D3D12HelloTriangle::LoadAssets()
{
	...
	ThrowIfFailed(m_device->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, m_commandAllocator.Get(), nullptr/*m_pipelineState.Get()*/, IID_PPV_ARGS(&m_commandList)));
